...
function showHelp {
    ...
    echo "          [outtrainfile] is the fully qualified filename for the output training file (required)"
    echo "          [outtestfile] is the fully qualified filename for the output test file (required)"
