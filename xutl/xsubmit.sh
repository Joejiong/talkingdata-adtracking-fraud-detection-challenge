...
# Usage:
#
#   xsubmit.sh [infile] [submissionfile] [modelfile]
#
#   example: xsubmit.sh ../data/test.csv ../data/submission.csv ../models/model-final-auc-1.0.h5
#
...
function showHelp {
    ...
    echo "Error: $1"
    echo " "
    echo "    xsubmit.sh [infile] [submissionfile] [modelfile]"
    echo " "
    ...
    echo " "
    echo "    example 1:  ./xsubmit.sh ../data/transform-test.h5 ../data/submission.csv ../models/dense-model-final.h5"
    echo " "
}
